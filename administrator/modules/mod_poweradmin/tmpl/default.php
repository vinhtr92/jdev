...
$JSNPAVersion	= '';
if (class_exists('PoweradminHelper'))
{
	$JSNPAVersion = PoweradminHelper::getVersion();
}


$document->addStyleSheet(JURI::root(true).'/administrator/modules/mod_poweradmin/assets/css/mod_poweradmin_quickicon.css?v=' . $JSNPAVersion);
?>
