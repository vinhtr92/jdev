...
<script type="text/javascript">
	...
	public function uninstall($parent)
	{
		...
		$this->uninstallPAExtensionSupprortPlugins();
	}
	...
	protected function updateExtension($extension)
	{
		...
		if ( ! $found && $extension->type == 'module' )
		{
	...
	protected function uninstallPAExtensionSupprortPlugins()
	{
		...
		if (count($items))
		{
			...
			$this->app->enqueueMessage('Successfully removed all PAExtension Supprort Plugins');
		}
	}
