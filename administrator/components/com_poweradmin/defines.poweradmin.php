...
define('JSN_POWERADMIN_UPGRADE_LINK', 'https://www.joomlashine.com/joomla-extensions/jsn-poweradmin-pro-joomla-extension.html');
...
define('JSN_POWERADMIN_VERSION', '2.5.2');
...
$unsupportedComponents['com_redshop'] = 'com_redshop';
define('JSNPA_UNSUPPORTED_COM_LIST', json_encode($unsupportedComponents));
