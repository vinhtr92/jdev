...
class JFormFieldJsnshowcase extends JFormField
{
	protected function getInput()
	{
		...
		if ($option == 'com_menus' && $view == 'item' && $layout == 'edit' && version_compare($JVersion, '3.7', '>='))
		{
			if (file_exists(JPATH_ROOT . '/media/media/js/mediafield.min.js'))
			{

				$document->addScriptVersion(JUri::root(true) . '/media/media/js/mediafield.min.js');
			}
		}
		...
		JSNHtmlAsset::addScript($uri . '/administrator/components/com_imageshow/assets/js/joomlashine/module.conflict.js');
