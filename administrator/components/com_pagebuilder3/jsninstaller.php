...
)  CHARACTER SET `utf8`;", "DROP TABLE IF EXISTS `#__jsn_pagebuilder3_revisions`" , "CREATE TABLE IF NOT EXISTS `#__jsn_pagebuilder3_revisions` ( `id` INT(11) NOT NULL AUTO_INCREMENT, `page_hash` VARCHAR(15) NOT NULL, `status` VARCHAR(15) DEFAULT 'normal', `revision_data` MEDIUMTEXT NULL DEFAULT NULL , `revision_html` MEDIUMTEXT NULL DEFAULT NULL , `updated` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , PRIMARY KEY (`id`), INDEX (`page_hash`)) ENGINE = InnoDB;");
