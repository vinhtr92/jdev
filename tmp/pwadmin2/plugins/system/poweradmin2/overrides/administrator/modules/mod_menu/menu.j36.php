...
class JAdminCssMenu extends JObject
{
	...
	public function renderLevel($depth)
	{
		...
		{
			echo "<a" . $linkClass . " " . $dataToggle . " href=\"" . $this->_current->link . "\">" . $this->_current->title .
				 $dropdownCaret . "</a>";
		}
	...
	public function load($params, $enabled)
	{
		...
		require JPATH_ADMINISTRATOR . '/modules/mod_menu/tmpl/default_' . ( $enabled ? 'enabled' : 'disabled' ) . '.php';
