...
<div>
	<div class="<?php echo $className .'-category' . $displayData->pageclass_sfx; ?>">
		...
		<h1 data-option data-content data-visibility="show_page_heading" data-visibility-value="<?php echo $params->get('show_page_heading'); ?>">
			<?php echo $displayData->escape($params->get('page_heading')); ?>
		</h1>
		<?php //endif; ?>

		<?php //if ($params->get('show_category_title', 1)) : ?>
		<h2 data-option data-visibility="show_category_title" data-visibility-value="<?php echo $params->get('show_category_title'); ?>">
		...
		<?php echo preg_replace(
			'#^<([^\s]+)([^>]*)>#',
			'<\\1\\2 data-option data-visibility="show_cat_tags" data-visibility-value="' . $params->get('show_cat_tags', 1) . '">',
			trim( JLayoutHelper::render('joomla.content.tags', $tagsData) )
		); ?>
		<?php //endif; ?>
		...
		<div class="category-desc">
			...
			<div data-option data-visibility="show_description_image" data-visibility-value="<?php echo $params->get('show_description_image'); ?>">
			...
			<div data-option data-visibility="show_description" data-visibility-value="<?php echo $params->get('show_description'); ?>">
		...
		<?php if ($displayData->maxLevel != 0 && $displayData->get('children')) : ?>
			<div class="cat-children">
				...
				<h3 data-option data-visibility="show_category_heading_title_text" data-visibility-value="<?php echo $params->get('show_category_heading_title_text'); ?>">
