...
<?php //if ($displayData->state == 0 || $params->get('show_title') || ($params->get('show_author') && !empty($displayData->author ))) : ?>
	<div class="page-header">
		<?php //if ($params->get('show_title')) : ?>
			<h2 itemprop="name" data-option data-visibility="show_title" data-visibility-value="<?php echo $params->get('show_title'); ?>" data-linked="link_titles" data-linked-value="<?php echo $params->get('link_titles'); ?>">
				<span>
