...
<div class="contact<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Person">
	<?php //if ($tparams->get('show_page_heading')) : ?>
		<h1 data-option data-content data-visibility="show_page_heading" data-visibility-value="<?php echo $tparams->get('show_page_heading'); ?>">
			<?php echo $this->escape($tparams->get('page_heading')); ?>
		</h1>
	<?php //endif; ?>

	<?php if ($this->contact->name/* && $tparams->get('show_name')*/) : ?>
		<div class="page-header" data-option data-content data-visibility="show_name" data-visibility-value="<?php echo $tparams->get('show_name'); ?>">
			<h2>
	...
	<?php if (/*$tparams->get('show_contact_list') && */count($this->contacts) > 1) : ?>
		<form action="#" method="get" name="selectForm" id="selectForm" data-option data-visibility="show_contact_list" data-visibility-value="<?php echo $tparams->get('show_contact_list'); ?>">
	...
	<?php if (/*$tparams->get('show_tags', 1) && */!empty($this->item->tags->itemTags)) : ?>
		...
		<?php echo preg_replace(
			'#^<([^\s]+)([^>]*)>#',
			'<\\1\\2 data-option data-visibility="show_tags" data-visibility-value="' . $tparams->get('show_tags', 1) . '">',
			trim( $this->item->tagLayout->render($this->item->tags->itemTags) )
		); ?>
	<?php endif; ?>
	...
	<div data-option data-visibility="show_info" data-visibility-value="<?php echo $tparams->get('show_info', 1); ?>">
		...
		<div class="thumbnail pull-right" data-option data-visibility="show_image" data-visibility-value="<?php echo $tparams->get('show_image'); ?>">
		...
		<dl class="contact-position dl-horizontal" data-option data-visibility="show_position" data-visibility-value="<?php echo $tparams->get('show_position'); ?>">
	...
	<div data-option data-visibility="show_email_form" data-visibility-value="<?php echo $tparams->get('show_email_form'); ?>">
		<?php if ($presentation_style === 'sliders') : ?>
	...
	<div data-option data-visibility="show_links" data-visibility-value="<?php echo $tparams->get('show_links'); ?>">
		<?php echo $this->loadTemplate('links'); ?>
	</div>
	<?php //endif; ?>

	<?php if (/*$tparams->get('show_articles') && */$this->contact->user_id && $this->contact->articles) : ?>
	<div data-option data-visibility="show_articles" data-visibility-value="<?php echo $tparams->get('show_articles'); ?>">
		<?php if ($presentation_style === 'sliders') : ?>
			<?php if (!$accordionStarted)
			{
	...
	<div data-option data-visibility="show_profile" data-visibility-value="<?php echo $tparams->get('show_profile'); ?>">
		<?php if ($presentation_style === 'sliders') : ?>
			<?php if (!$accordionStarted)
			{
	...
	<div data-option data-visibility="show_user_custom_fields" data-visibility-value="<?php echo $tparams->get('show_user_custom_fields'); ?>">
		<?php echo $this->loadTemplate('user_custom_fields'); ?>
	</div>
	<?php endif; ?>

	<?php if ($this->contact->misc/* && $tparams->get('show_misc')*/) : ?>
	<div data-option data-visibility="show_misc" data-visibility-value="<?php echo $tparams->get('show_misc'); ?>">
		<?php if ($presentation_style === 'sliders') : ?>
			<?php if (!$accordionStarted)
			{
