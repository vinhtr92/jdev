			...
			<tbody>
				<?php foreach ($this->items as $i => $item) : ?>
					...
					<?php endif; ?>
						...
						<td headers="categorylist_header_date" class="list-date small" data-option data-visibility="tag_list_show_date" data-visibility-value="<?php echo $this->params->get('tag_list_show_date'); ?>">
							<?php
							echo JHtml::_(
...
<?php if (!empty($this->items)) : ?>
	...
	<div class="pagination">
		...
		<p class="counter pull-right" class="list-date small" data-option data-visibility="show_pagination_results" data-visibility-value="<?php echo $this->params->def('show_pagination_results', 1); ?>">
