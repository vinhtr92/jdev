...
<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
	...
	<ul class="category list-striped">
		<?php foreach ($items as $i => $item) : ?>
			...
			<div data-option data-visibility="tag_list_show_item_image" data-visibility-value="<?php echo $this->params->get('tag_list_show_item_image', 1); ?>">
				<a href="<?php echo JRoute::_(TagsHelperRoute::getItemRoute($item->content_item_id, $item->core_alias, $item->core_catid, $item->core_language, $item->type_alias, $item->router)); ?>">
			...
			<div data-option data-visibility="tag_list_show_item_description" data-visibility-value="<?php echo $this->params->get('tag_list_show_item_description', 1); ?>">
