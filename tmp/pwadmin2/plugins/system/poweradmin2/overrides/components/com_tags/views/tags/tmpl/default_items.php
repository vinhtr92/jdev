	...
	<?php else : ?>
		...
		<?php endif; ?>
			<?php if (/*$this->params->get('all_tags_show_tag_image') && */!empty($item->images)) : ?>
				...
				<span class="tag-body" data-option data-visibility="all_tags_show_tag_image" data-visibility-value="<?php echo $this->params->get('all_tags_show_tag_image'); ?>">
			...
			<div class="caption">
				...
				<span class="tag-body" data-option data-visibility="all_tags_show_tag_description" data-visibility-value="<?php echo $this->params->get('all_tags_show_tag_description', 1); ?>">
					<?php echo JHtml::_('string.truncate', $item->description, $this->params->get('all_tags_tag_maximum_characters')); ?>
				</span>
				<?php endif; ?>
				<?php //if ($this->params->get('all_tags_show_tag_hits')) : ?>
				<span class="list-hits badge badge-info" data-option data-visibility="all_tags_show_tag_hits" data-visibility-value="<?php echo $this->params->get('all_tags_show_tag_hits'); ?>">
