	...
	<table class="category table table-striped table-bordered table-hover<?php echo $tableClass; ?>">
		...
		<thead>
			<tr>
				...
				<th scope="col" id="categorylist_header_author" data-option data-visibility="list_show_author" data-visibility-value="<?php echo $this->params->get('list_show_author'); ?>">
					<?php echo JHtml::_('grid.sort', 'JAUTHOR', 'author', $listDirn, $listOrder); ?>
				</th>
				<?php //endif; ?>
				<?php //if ($this->params->get('list_show_hits')) : ?>
				<th scope="col" id="categorylist_header_hits" data-option data-visibility="list_show_hits" data-visibility-value="<?php echo $this->params->get('list_show_hits'); ?>">
					<?php echo JHtml::_('grid.sort', 'JGLOBAL_HITS', 'a.hits', $listDirn, $listOrder); ?>
				</th>
				<?php //endif; ?>
				<?php if (/*$this->params->get('list_show_votes', 0) && */$this->vote) : ?>
				<th scope="col" id="categorylist_header_votes" data-option data-visibility="list_show_votes" data-visibility-value="<?php echo $this->params->get('list_show_votes', 0); ?>">
					<?php echo JHtml::_('grid.sort', 'COM_CONTENT_VOTES', 'rating_count', $listDirn, $listOrder); ?>
				</th>
				<?php endif; ?>
				<?php if (/*$this->params->get('list_show_ratings', 0) && */$this->vote) : ?>
				<th scope="col" id="categorylist_header_ratings" data-option data-visibility="list_show_ratings" data-visibility-value="<?php echo $this->params->get('list_show_ratings', 0); ?>">
		...
		<?php foreach ($this->items as $i => $article) : ?>
			...
			<td headers="categorylist_header_title" class="list-title">
				...
				<td headers="categorylist_header_author" class="list-author" data-option data-visibility="list_show_author" data-visibility-value="<?php echo $this->params->get('list_show_author'); ?>">
				...
				<td headers="categorylist_header_hits" class="list-hits" data-option data-visibility="list_show_hits" data-visibility-value="<?php echo $this->params->get('list_show_hits'); ?>">
				...
				<?php //endif; ?>
				<?php if (/*$this->params->get('list_show_votes', 0) && */$this->vote) : ?>
				<td headers="categorylist_header_votes" class="list-votes" data-option data-visibility="list_show_votes" data-visibility-value="<?php echo $this->params->get('list_show_votes', 0); ?>">
				...
				<?php endif; ?>
				<?php if (/*$this->params->get('list_show_ratings', 0) && */$this->vote) : ?>
				<td headers="categorylist_header_ratings" class="list-ratings" data-option data-visibility="list_show_ratings" data-visibility-value="<?php echo $this->params->get('list_show_ratings', 0); ?>">
...
<?php if (!empty($this->items)) : ?>
	<?php if (($this->params->def('show_pagination', 2) == 1  || ($this->params->get('show_pagination') == 2)) && ($this->pagination->pagesTotal > 1)) : ?>
		<div class="pagination">
			...
			<p class="counter pull-right" data-option data-visibility="show_pagination_results" data-visibility-value="<?php echo $this->params->def('show_pagination_results', 1); ?>">
