		...
		<?php $class = ''; ?>
			<h3 class="page-header item-title">
				...
				<?php //if ($this->params->get('show_cat_num_articles_cat') == 1) :?>
					<span class="badge badge-info tip hasTooltip" title="<?php echo JHtml::_('tooltipText', 'COM_CONTENT_NUM_ITEMS_TIP'); ?>" data-option data-visibility="show_cat_num_articles_cat" data-visibility-value="<?php echo $this->params->get('show_cat_num_articles_cat'); ?>">
			...
			<?php //if ($this->params->get('show_subcat_desc_cat') == 1) : ?>
				<?php if ($item->description) : ?>
					<div class="category-desc" data-option data-visibility="show_subcat_desc_cat" data-visibility-value="<?php echo $this->params->get('show_subcat_desc_cat'); ?>">
