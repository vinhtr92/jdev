...
else
{
	...
	<h1 class="<?php echo $direction; ?>" data-option data-content data-visibility="display_num" data-visibility-value="<?php echo $this->params->get('display_num'); ?>">
	...
	<div class="feed-description" data-option data-visibility="show_feed_description" data-visibility-value="<?php echo $this->params->get('show_feed_description'); ?>">
	...
	<div data-option data-visibility="show_feed_image" data-visibility-value="<?php echo $this->params->get('show_feed_image'); ?>">
	...
	<?php for ($i = 0; $i < $this->item->numarticles; $i++)
	{
		...
		?>
			<li>
				...
				<div class="feed-item-description" data-option data-visibility="show_item_description" data-visibility-value="<?php echo $this->params->get('show_item_description'); ?>">
