	...
	<?php //endif; ?>
		<ul class="category list-striped list-condensed">
			<?php foreach ($this->items as $i => $item) : ?>
				...
				<span class="list-hits badge badge-info pull-right" data-option data-visibility="show_articles" data-visibility-value="<?php echo $this->params->get('show_articles'); ?>">
				...
				<span class="list pull-left" data-option data-visibility="show_link" data-visibility-value="<?php echo $this->params->get('show_link'); ?>">
