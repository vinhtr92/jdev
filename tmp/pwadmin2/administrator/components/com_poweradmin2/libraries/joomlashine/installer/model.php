...
class JSNInstallerModel extends JModelLegacy
{
		...
		try
		{
			...
			if (class_exists('JsnExtFwHelper'))
			{
				...
				JsnExtFwHelper::saveSettings($input->getCmd('option'),
					array(
						'live_update_notification' => $input->getInt('live_update_notification')
					), true);
			}
	 ...
	 */
	protected function hasUpdate($identified_name, $current_version, $requiredJoomlaVersion = JSN_POWERADMIN2_REQUIRED_JOOMLA_VER, $version = '')
	{
		static $result;
