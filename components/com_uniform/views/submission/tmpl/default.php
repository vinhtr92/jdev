...
if ((string) $this->_infoForm->form_edit_submission == '1')
{
	...
	<div class="submission-content">
        ...
        if ($this->_formPages)
        {
            foreach ($this->_formPages as $formPages)
            {
                ...
                ?>
                <div class="submission-page" data-title="<?php echo $formPages->page_title; ?>"
                     data-value="<?php echo $formPages->page_id; ?>">
